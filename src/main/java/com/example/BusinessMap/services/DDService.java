...
@Component
public class DDService implements CommandLineRunner {
    @Autowired
    ...
    public DDService(PlaceRepository placeRepository, TypeRepository typeRepository, PlaceService placeService) {
